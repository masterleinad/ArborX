            ...
            value)>::type * = 0)
{
  ...
  Kokkos::View<typename View::traits::data_type, Kokkos::LayoutRight,
                      typename ExecutionSpace::memory_space> layout_right_view(
      Kokkos::ViewAllocateWithoutInitializing(std::string(src.label()).append("_layout_right_mirror")), src.extent(0),
...
return View(label, 
	    rank>0?0:KOKKOS_IMPL_CTOR_DEFAULT_ARG,
